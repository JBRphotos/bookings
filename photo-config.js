/*  ┌─────────────────────────────────────────────────────────────┐
    │              ★  JBR PHOTOS — PHOTO CONFIG  ★                │
    │                                                             │
    │   Controls all IMAGES across the website.                   │
    │   For TEXT, see site-text.js                                │
    │                                                             │
    │   Edit on GitHub → Commit → Site updates automatically.     │
    │   Or use the Admin Panel to change everything visually.     │
    └─────────────────────────────────────────────────────────────┘ */
...
var sections = [
    {
        ...
        banner: 'images/events/photo1.jpg', folder: 'images/events',
        albums: [
